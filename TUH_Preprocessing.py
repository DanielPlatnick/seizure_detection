...
def extract_signal(f, signal_labels, electrode_name, start, stop):
    ...
    original_start_index = int(np.floor(new_sig_start * float(original_sample_frequency)))
    original_stop_index = int(np.floor(new_sig_end * float(original_sample_frequency)))
...
def main():
    ...
    if platform.system() == 'Linux':
        parser.add_argument('--base_dir', default='/home/dplatnick/TUHData',
                            help='path to raw seizure dataset')
        parser.add_argument('--save_data_dir', default='/home/dplatnick/TUH_Output_test',
                            help='path to save processed data')
    elif platform.system() == 'Darwin':
        parser.add_argument('--base_dir', default='/home/dplatnick/TUHData',
                            help='path to raw seizure dataset')
        parser.add_argument('--save_data_dir',
                            default='/home/dplatnick/TUH_Output_test',
                            help='path to save processed data')
    else:
